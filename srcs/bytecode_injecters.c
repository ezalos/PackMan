...
/*   Updated: 2021/03/25 15:47:16 by ezalos           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	inject_def_cypher_prepare(t_packer *packer, uint8_t *dest, void *args)
{
	uint8_t payload[SIZE_DEF_CYPHER_PREPARE] = {
		...
		0xc7, 0x84, 0x24, 0x00, 0x01, 0x00, 0x00,   //mov    DWORD PTR [rsp+0x100],0x0
		0x00, 0x00, 0x00, 0x00, 
		0xc7, 0x84, 0x24, 0x04, 0x01, 0x00, 0x00,   //mov    DWORD PTR [rsp+0x104],0x0
		0x00, 0x00, 0x00, 0x00, 
